const Sizing = () => {
    return (
        <div>
            ...
            <div className="bg-black text-white w-4">Tailwind w-4</div>
            <div className="bg-green-500 text-white w-48">Tailwind w-48</div>
            <div className="bg-blue-700 text-white w-96">Tailwind w-96</div>

            {/* Percentages  */}

            <div className="bg-purple-700 text-white w-1/4">Tailwind w-1/4</div>
            <div className="bg-green-700 text-white w-1/3">Tailwind w-1/3</div>
            <div className="bg-red-700 text-white w-1/2">Tailwind w-1/2</div>

            {/* Width of the viewport  */}

            <div className="bg-purple-700 text-white w-screen">Tailwind w-1/2</div>

            {/* 100% of container  */}

            <div className="bg-blue-700 text-white w-full">Tailwind 100% container</div>

            {/* Arbitrary width  */}

            <div className="bg-blue-700 text-white w-[300px]">Tailwind Arbitrary width</div>

            {/* Max Width  */}

            <div className="max-w-lg bg-blue-300 text-white">
            ...
            <div className="flex items-end">
                <div className="bg-orange-500 w-20 h-24">Items h-24</div>
                <div className="bg-orange-500 w-20 h-32">Items h-32</div>
                <div className="bg-orange-500 w-20 h-40">Items h-40</div>
                <div className="bg-orange-500 w-20 h-48">Items h-48</div>
                <div className="bg-orange-500 w-20 h-64">Items h-64</div>
            </div>

            {/* Full screen height  */}
            <div className="bg-purple-500 w-20 h-screen">Items 5</div>
