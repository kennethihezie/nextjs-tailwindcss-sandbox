const Container = () => {
    return (
        ...
        <article>
         ...
         <div className="bg-slate-100 ml-4">
            Margin left
         </div>

         <div className="bg-slate-100 mr-4">
            Margin right
         </div>
         ...
         {/* arbitary Values..Not recomended*/}
         ...
         <div className="bg-slate-100 pl-4">
            Padding left
         </div>

         <div className="bg-slate-100 pr-4">
            Padding right
         </div>
         ...
         {/* arbitary Values..Not recomended*/}
         <div className="bg-slate-100 pt-[20px]">
           Arbitary Values
         </div>
