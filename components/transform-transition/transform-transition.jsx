const Transform = () => {
    return (
       <div>
         {/* No transition */}
         <button className="button px-8 py-2 m-24 text-white bg-blue-500 rounded hover:bg-blue-700">Click Me</button>
         {/* Transition  */}
         <button className="button px-8 py-2 m-24 text-white bg-blue-500 rounded hover:bg-blue-700 transition-colors duration-1000">Click Me</button>
         <button className="button px-8 py-2 m-24 text-white bg-blue-500 rounded hover:bg-blue-700 transition duration-1000">Click Me</button>
         <button className="button px-8 py-2 m-24 text-white bg-blue-500 rounded hover:bg-blue-700 transition duration-1000 hover:opacity-20">Click Me</button>

         {/* Transition & Transform  */}

         <button className="button px-8 py-2 m-24 text-white bg-blue-500 rounded hover:bg-blue-700 hover:rotate-12 transition-transform duration-1000">Click Me</button>
         <img className="w-48 hover:rotate-180 hover:scale-75 hover-skew-x-12 duration-1000 transition-transform" src="/images/img1.jpg" alt="" />
         <img className="w-48 hover:rotate-180 hover:scale-75 hover-skew-x-12 duration-1000" src="/images/img2.jpg" alt="" />
       </div>
    )
}
